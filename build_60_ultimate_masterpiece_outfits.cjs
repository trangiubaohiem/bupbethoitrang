...
// PERFECT 60 UNICITY & RARITY GRADUATION MAPPING
const OUTFIT_MAP = {
  ...
  // MAP 10: Mật Thất Kim Tự Tháp (Pyramid / Pharaoh / Cleopatra - 4 UNICO)
  ...
  // MAP 13: Núi Lửa Thái Dương (Solar Phoenix - 4 UNICO PER RARITY GRADUATION)
  m13_2star: path.join(artDir, 'gen_m13_2star_1789241857508.png'), // Sun Girl, NO wings!
  m13_3star: path.join(artDir, 'gen_m13_3star_1789241880980.png'), // Flame Mage, NO wings!
  m13_epic: path.join(artDir, 'clean_m13_solar_epic_1789241511040.png'), // Fire Valkyrie!
  m13_legendary: path.join(artDir, 'ai_m13_phoenix_1789241202455.png'), // Solar Phoenix with Fire Wings!

  // MAP 14: Tháp Phù Thủy Tinh Tú (Star Witch - 4 UNICO PER RARITY GRADUATION)
  m14_2star: path.join(artDir, 'gen_m14_2star_1789241901017.png'), // Novice Witch, NO wings!
  m14_3star: path.join(artDir, 'gen_m14_3star_1789241923129.png'), // Star Witch Broom, NO wings!
  m14_epic: path.join(artDir, 'ai_m3_mage_1789241160305.png'), // Astral Witch Gown!
  m14_legendary: path.join(artDir, 'map14_witch_legendary_1789241367673.png'), // Star Witch Sovereign with Gothic Wings!

  // MAP 15: Đền Thần Vũ Trụ Supreme (Supreme Goddess - 4 UNICO PER RARITY GRADUATION)
  m15_2star: path.join(artDir, 'gen_m15_2star_1789241945271.png'), // Supreme Knight, NO wings!
  m15_3star: path.join(artDir, 'gen_m15_3star_1789241967003.png'), // Supreme Priestess, NO wings!
  m15_epic: path.join(artDir, 'clean_m11_galaxy_epic_1789241474591.png'), // Supreme Goddess!
  m15_legendary: path.join(artDir, 'ai_set_starlight_legendary_1789240675721.png'), // Supreme Cosmic Empress with Wings & Bling!
};
...
async function main() {
  console.log('--- Generating 60 ULTIMATE MASTERPIECE Anime Chibi Outfits (Intact Feet, Zero Duplicates, Strict Rarity & Map Themes) ---');
  ...
  for (let map = 1; map <= 15; map++) {
    for (const rarity of rarities) {
      ...
      if (fs.existsSync(srcPath)) {
        ...
        // FIT CHARACTER (maxDim = 360, dy = 30) SO HEAD & FEET ARE 100% INTACT & VISIBLE
        const maxDim = 360;
  ...
  console.log('🎉 ALL 60 ULTIMATE MASTERPIECE OUTFITS RENDERED 100% PERFECTLY!');
}
